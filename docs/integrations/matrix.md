...
|------|----------|-----|----------------------|---------------------------|--------------------|---------------------------|--------|
| **1** | **Cursor** | Yes (HTTP or stdio) | **User rules** + optional **`.cursor/rules/pluribus.mdc`** | **`skill.md`**, **`skills/pluribus/`** → **`~/.cursor/skills/`** | **`~/.cursor/mcp.json`** (ideal) | HTTP **`POST /v1/mcp`** + rules | [helper/verify-mcp](../../integrations/cursor/helper/verify-mcp); tools in Agent |
