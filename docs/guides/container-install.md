...
Build-from-source remains valid for **developers**; it is **not** the default public story — see [pluribus-public-architecture.md](../architecture.md).
...
See [pluribus-image-release-policy.md](images.md) for tags (`main`, `sha-*`, `v*`, `latest`).
...
This starts **postgres**, **redis**, and **pluribus** on **:8123** (first pull may take a minute).
...
- **HTTP:** `http://127.0.0.1:8123/v1/...` — see [guides/quickstart-lab.md](../guides/quickstart-lab.md).  
...
- [operate/guide.md](operate/guide.md) — config, auth, CI  
- [get-started.md](../get-started.md) — alternate paths (local Postgres)  
- [deployment-poc.md](../archive/deployment-poc.md) — deeper runbook  
