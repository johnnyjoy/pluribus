...
- **Global memory system** — durable constraints, decisions, failures, patterns; recall, enforcement, curation; **tags** and shared pool semantics ([pluribus-memory-first-ontology.md](../ontology.md)).
...
- **Proof scenario system** — YAML + integration receipts ([proof-scenarios.md](../proof/scenarios.md), [pluribus-proof-index.md](../proof/README.md)).
