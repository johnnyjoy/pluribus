# OpenClaw — Pluribus policy snippet

Register **Pluribus** via **`openclaw mcp`** (see **[OpenClaw MCP CLI](https://docs.openclaw.ai/cli/mcp)**), then pin the text below in your gateway’s **system / policy** field so every run keeps the **Pluribus** loop.
