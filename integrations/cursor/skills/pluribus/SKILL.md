...
6. record_experience (after outcome). Optional occurred_at (RFC3339). One dense claim, not an essay. Clock questions: pass occurred_after/occurred_before as RFC3339.
