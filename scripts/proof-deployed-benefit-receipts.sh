...
if [[ $rc -ne 0 ]]; then
  {
    ...
    echo "Deployed servers use hive formation (active at capped authority). Failures usually mean"
    echo "warehouse defaults, pending sinks, or consolidate traps — not flaky tests."
    echo ""
